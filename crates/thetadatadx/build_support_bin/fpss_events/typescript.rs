...
pub(super) fn render_ts_fpss_event_classes(schema: &Schema) -> String {
    ...
    out.push_str("// Typed #[napi(object)] structs for every `FpssData` and `FpssControl`\n");
    out.push_str("// variant + a flat `FpssEvent` wrapper and the `buffered_event_to_typed`\n");
