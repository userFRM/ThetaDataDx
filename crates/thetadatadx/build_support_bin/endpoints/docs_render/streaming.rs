...
const STREAMS: &[StreamSpec] = &[
    ...
    StreamSpec {
        ...
        event: "Quote",
        rust_sub: "Contract::option(\"SPY\", \"20260618\", \"570\", \"C\")?.quote()",
        python_sub: "Contract.option(\"SPY\", \"20260618\", \"570\", \"C\").quote()",
        ts_sub: "Contract.option('SPY', '20260618', '570', 'C').quote()",
        cpp_sub: "tdx::Contract::option(\"SPY\", \"20260618\", \"570\", \"C\").quote()",
        ws_req_type: "QUOTE",
        ws_sec_type: "OPTION",
    ...
    StreamSpec {
        ...
        event: "Trade",
        rust_sub: "Contract::option(\"SPY\", \"20260618\", \"570\", \"C\")?.trade()",
        python_sub: "Contract.option(\"SPY\", \"20260618\", \"570\", \"C\").trade()",
        ts_sub: "Contract.option('SPY', '20260618', '570', 'C').trade()",
        cpp_sub: "tdx::Contract::option(\"SPY\", \"20260618\", \"570\", \"C\").trade()",
        ws_req_type: "TRADE",
        ws_sec_type: "OPTION",
        ws_contract: Some(r#"{"symbol": "SPY", "expiration": 20260618, "strike": 570000, "right": "C"}"#),
        group: "Options",
    ...
    StreamSpec {
        ...
        event: "OpenInterest",
        rust_sub: "Contract::option(\"SPY\", \"20260618\", \"570\", \"C\")?.open_interest()",
        python_sub: "Contract.option(\"SPY\", \"20260618\", \"570\", \"C\").open_interest()",
        ts_sub: "Contract.option('SPY', '20260618', '570', 'C').openInterest()",
        cpp_sub: "tdx::Contract::option(\"SPY\", \"20260618\", \"570\", \"C\").open_interest()",
