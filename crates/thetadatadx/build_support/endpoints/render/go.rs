...
use super::super::helpers::{
    ffi_free_fn, ffi_header_return_type, ffi_option_has_flag, go_c_var_name, go_converter_name,
    go_method_arg_decl, go_result_type, is_streaming_endpoint, method_params, sdk_method_arg_name,
    to_camel_case, to_go_exported_name,
};
use super::super::model::{GeneratedEndpoint, GeneratedParam};

pub(super) fn render_go_options(params: &[GeneratedParam]) -> String {
    let mut out = String::new();
    // Go's tooling (go vet, gofmt, staticcheck) recognizes auto-generated
    // files via the regex `^// Code generated .* DO NOT EDIT\.$`
    // (https://golang.org/s/generatedcode). The non-Go `@generated` form
    // breaks that recognition, so every .go file we emit must follow the
    // spec literally. Other languages (Rust/Python/C++) keep the uniform
    // `@generated` form since no analogous spec applies there.
...
pub(super) fn render_go_endpoint_ffi_sizes(params: &[GeneratedParam]) -> String {
    let mut out = String::new();
    out.push_str("// Code generated by build.rs from endpoint_surface.toml; DO NOT EDIT.\n\n");
    out.push_str("package thetadatadx\n\n");
    writeln!(
        out,
        "const TdxEndpointRequestOptionsExpectedSize uintptr = {}",
        endpoint_request_options_size(params)
    )
    .unwrap();
    out
}

fn endpoint_request_options_size(params: &[GeneratedParam]) -> usize {
    let mut layout = CLayout::default();
    for param in params {
        match param.param_type.as_str() {
            "Int" | "Bool" => layout.push(4, 4),
            "Float" => layout.push(8, 8),
            _ => layout.push(
...
impl CLayout {
    fn push(&mut self, size: usize, align: usize) {
        self.align = self.align.max(align);
        self.size = align_to(self.size, align) + size;
    }
...
pub(super) fn render_go_historical(endpoints: &[GeneratedEndpoint]) -> String {
    let mut out = String::new();
    // Go spec header (see render_go_options for the rationale).
    out.push_str("// Code generated by build.rs from endpoint_surface.toml; DO NOT EDIT.\n\n");
    out.push_str("package thetadatadx\n\n");
    out.push_str("/*\n#include \"ffi_bridge.h\"\n*/\nimport \"C\"\n\n");
    out.push_str("import (\n");
