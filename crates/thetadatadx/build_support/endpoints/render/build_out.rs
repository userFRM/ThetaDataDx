...
//! shared endpoint dispatch runtime, and the three per-kind `DirectClient`
//! extension impls (list, parsed, streaming). The [`generate_all`] entry
...
use super::direct::{
    generate_direct_list_endpoint, generate_direct_parsed_endpoint,
    generate_direct_streaming_endpoint,
};
