...
pub struct CalendarDay {
    ...
    pub status: crate::types::enums::CalendarStatus,
}
...
impl EodTick {
    ...
    pub fn created_timestamp_ms(&self) -> Option<i64> {
        crate::time::date_ms_to_epoch_ms(self.date, self.created_ms_of_day)
    }
    /// Unix epoch milliseconds (UTC, DST-aware) combining `date`
    ...
    pub fn last_trade_timestamp_ms(&self) -> Option<i64> {
        crate::time::date_ms_to_epoch_ms(self.date, self.last_trade_ms_of_day)
    }
}
...
impl GreeksAllTick {
    ...
    pub fn timestamp_ms(&self) -> Option<i64> {
        crate::time::date_ms_to_epoch_ms(self.date, self.ms_of_day)
    }
    /// Unix epoch milliseconds (UTC, DST-aware) combining `date`
    ...
    pub fn underlying_timestamp_ms(&self) -> Option<i64> {
        crate::time::date_ms_to_epoch_ms(self.date, self.underlying_ms_of_day)
    }
}
...
impl TradeQuoteTick {
    ...
    pub fn quote_timestamp_ms(&self) -> Option<i64> {
        crate::time::date_ms_to_epoch_ms(self.date, self.quote_ms_of_day)
    }
}
