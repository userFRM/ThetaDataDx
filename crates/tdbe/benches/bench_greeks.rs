...
fn bench_all_greeks(c: &mut Criterion) {
    c.bench_function("all_greeks", |b| {
        b.iter(|| {
            ...
            let price = greeks::value(s, x, 0.22, r, q, t, "C");
...
fn bench_all_greeks_individual(c: &mut Criterion) {
    c.bench_function("all_greeks_individual", |b| {
        b.iter(|| {
            ...
            let t = black_box(45.0 / 365.0);
            let v = 0.22;
            let val = greeks::value(s, x, v, r, q, t, "C");
            let d = greeks::delta(s, x, v, r, q, t, "C");
            let g = greeks::gamma(s, x, v, r, q, t);
            let th = greeks::theta(s, x, v, r, q, t, "C");
            let ve = greeks::vega(s, x, v, r, q, t);
            let rh = greeks::rho(s, x, v, r, q, t, "C");
            let ep = greeks::epsilon(s, x, v, r, q, t, "C");
            let la = greeks::lambda(s, x, v, r, q, t, "C");
            let va = greeks::vanna(s, x, v, r, q, t);
            let ch = greeks::charm(s, x, v, r, q, t, "C");
            ...
            let dd = greeks::dual_delta(s, x, v, r, q, t, "C");
...
fn bench_greeks_iv_solver(c: &mut Criterion) {
    ...
    let option_price = greeks::value(150.0, 155.0, 0.22, 0.05, 0.015, 45.0 / 365.0, "C");
