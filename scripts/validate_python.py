...
CELLS = [
    ...
    ("option_snapshot_market_value", "concrete", "value", lambda: client.option_snapshot_market_value("SPY", "20250321", "570", "C")),
    ("option_snapshot_market_value", "concrete_iso", "value", lambda: client.option_snapshot_market_value("SPY", "2025-03-21", "570", "C")),
    ("option_snapshot_market_value", "all_strikes_one_exp", "value", lambda: client.option_snapshot_market_value("SPY", "20250321", "*", "both")),
    ("option_snapshot_market_value", "all_exps_one_strike", "value", lambda: client.option_snapshot_market_value("SPY", "*", "570", "both")),
    ("option_snapshot_market_value", "bulk_chain", "value", lambda: client.option_snapshot_market_value("SPY", "*", "*", "both")),
    ("option_snapshot_market_value", "legacy_zero_wildcard", "value", lambda: client.option_snapshot_market_value("SPY", "0", "0", "both")),
