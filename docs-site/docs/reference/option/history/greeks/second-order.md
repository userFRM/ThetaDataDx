...
```python
rows = tdx.historical.option_history_greeks_second_order(
    "SPY",
    "20250321",
    "20250303",
    strike="570",
...
```typescript
const rows = await tdx.historical.optionHistoryGreeksSecondOrder('SPY', '20250321', '20250303', { strike: '570', right: 'C', interval: '1m' });
for (const t of rows) {
