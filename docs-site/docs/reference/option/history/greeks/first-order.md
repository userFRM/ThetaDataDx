...
```python
ThetaDataDxClient.option_history_greeks_first_order(
...
```python
rows = tdx.option_history_greeks_first_order(
    "SPY",
    "20250321",
    "20250303",
    strike="570",
...
```typescript
const rows = await tdx.optionHistoryGreeksFirstOrder('SPY', '20250321', '20250303', { strike: '570', right: 'C', interval: '1m' });
for (const t of rows) {
...
```cpp
auto rows = client.option_history_greeks_first_order("SPY", "20250321", "20250303",
