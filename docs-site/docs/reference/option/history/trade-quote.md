...
optionHistoryTradeQuote(
  ...
  endTime?: string | Date, exclusive?: boolean, maxDTE?: number,
  strikeRange?: number, startDate?: string | Date, endDate?: string | Date,
  timeoutMs?: number,
...
```typescript
const rows = tdx.optionHistoryTradeQuote('SPY', '20250321', '20250303', '570', 'C');
for (const t of rows) {
