...
```python
rows = tdx.historical.option_history_trade_greeks_all(
    "SPY",
    "20250321",
    "20250303",
    strike="570",
...
```typescript
const rows = await tdx.historical.optionHistoryTradeGreeksAll('SPY', '20250321', '20250303', { strike: '570', right: 'C' });
for (const t of rows) {
