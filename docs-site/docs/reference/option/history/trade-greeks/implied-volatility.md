...
```python
Client.historical.option_history_trade_greeks_implied_volatility(
...
```cpp
auto rows = client.historical().option_history_trade_greeks_implied_volatility("SPY", "20250321", "20250303",
