...
```python
rows = tdx.option_history_open_interest(
    "SPY",
    "20250321",
    "20250303",
    strike="570",
...
optionHistoryOpenInterest(
  ...
  strike?: string, right?: string, maxDTE?: number, strikeRange?: number,
...
```typescript
const rows = tdx.optionHistoryOpenInterest('SPY', '20250321', '20250303', '570', 'C');
for (const t of rows) {
