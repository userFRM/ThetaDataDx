...
```python
rows = tdx.historical.option_at_time_trade(
    "SPY",
    "20250321",
    "20250303",
    "20250306",
...
```typescript
const rows = await tdx.historical.optionAtTimeTrade('SPY', '20250321', '20250303', '20250306', '10:30:00.000', { strike: '570', right: 'C' });
for (const t of rows) {
