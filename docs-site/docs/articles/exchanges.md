---
title: Exchanges
description: Exchange code mapping for the exchange fields on trade and quote rows.
---

# Exchanges

The integer `exchange`, `bid_exchange`, and `ask_exchange` response fields use these codes, as published by ThetaData.

[Download as CSV](/csv/exchanges.csv)
...
| 76 | EMPTY | EMPT |
| 77 | 24X National Exchange | 24X |

Source: ThetaData's [Exchanges article](https://docs.thetadata.us/Articles/Errors-Exchanges-Conditions/Exchanges.html).
