...
let sub = Contract::option("SPY", "20260618", "570", "C")?.quote();
...
sub = Contract.option("SPY", "20260618", "570", "C").quote()
tdx.subscribe(sub)
...
const sub = Contract.option('SPY', '20260618', '570', 'C').quote();
tdx.subscribe(sub);
...
auto sub = tdx::Contract::option("SPY", "20260618", "570", "C").quote();
