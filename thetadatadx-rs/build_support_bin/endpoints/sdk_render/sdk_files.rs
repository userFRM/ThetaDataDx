...
use super::{
    config_accessors, cpp, cpp_validate, enums, ffi, python, python_stub, python_validate,
    typescript,
};
...
fn render_sdk_generated_files() -> Result<Vec<GeneratedSourceFile>, Box<dyn std::error::Error>> {
    ...
    Ok(vec![
        GeneratedSourceFile {
            relative_path: "thetadatadx-rs/src/tdbe/types/generated/enums_endpoint.rs",
            contents: enums::render_tdbe_enums(&enum_projections),
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-py/src/_generated/enums_generated.rs",
            contents: enums::render_python_enums(&enum_projections),
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-ts/src/_generated/enums_generated.rs",
            contents: enums::render_typescript_enums(&enum_projections),
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-ffi/src/endpoint_request_options.rs",
            contents: ffi::render_ffi_endpoint_request_options(&builder_params),
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-ffi/src/endpoint_with_options.rs",
            contents: ffi::render_ffi_with_options(&parsed.endpoints),
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-ffi/src/endpoint_stream.rs",
            contents: ffi::render_ffi_stream_endpoints(&parsed.endpoints),
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-ffi/src/config_accessors.rs",
            contents: config_accessors::render_ffi_config_accessors()?,
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-cpp/include/config_accessors.hpp.inc",
            contents: config_accessors::render_cpp_config_accessors()?,
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-py/src/_generated/config_accessors.rs",
            contents: config_accessors::render_python_config_accessors()?,
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-ts/src/_generated/config_accessors.rs",
            contents: config_accessors::render_typescript_config_accessors()?,
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-cpp/include/endpoint_request_options.h.inc",
        ...
        GeneratedSourceFile {
            relative_path: "thetadatadx-cpp/include/endpoint_options.hpp.inc",
        ...
        GeneratedSourceFile {
            relative_path: "thetadatadx-cpp/include/endpoint_with_options.h.inc",
        ...
        GeneratedSourceFile {
            relative_path: "thetadatadx-cpp/examples/validate.cpp",
