//! Emit `thetadatadx-rs/src/tdbe/types/generated/tick.rs` -- the
//! `#[repr(C, align(N))]` struct definitions for every tick type declared
//! in `tick_schema.toml`.
//!
//! The hand-written `thetadatadx-rs/src/tdbe/types/tick.rs` keeps the
...
/// Renders `thetadatadx-rs/src/tdbe/types/generated/tick.rs` — the `#[repr(C, align(N))]` struct definition and timestamp accessors for every tick type in the schema.
...
/// Emit `thetadatadx-rs/src/tdbe/types/generated/tick_layout_asserts.rs`
