//! Emit `thetadatadx-py/src/_generated/fpss_event_classes.rs` — typed `#[pyclass]`
...
/// `thetadatadx-ts/src/fluent.rs` where the two are also held apart.
...
pub(super) fn render_python_fpss_event_classes(schema: &Schema) -> String {
    ...
    out.push_str("// `thetadatadx-rs/fpss_event_schema.toml`.\n\n");
