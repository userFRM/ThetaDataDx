...
fn render_sdk_generated_files() -> Result<Vec<GeneratedSourceFile>, Box<dyn std::error::Error>> {
    ...
    Ok(vec![
        GeneratedSourceFile {
            relative_path: "thetadatadx-py/src/_generated/streaming_methods.rs",
            contents: python::render_python_streaming_methods(&python_unified_methods),
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-py/src/_generated/utility_functions.rs",
            contents: python::render_python_utility_functions(&python_utilities),
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-ts/src/_generated/streaming_methods.rs",
            contents: typescript::render_ts_streaming_methods(&ts_napi_methods),
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-ts/src/_generated/utility_functions.rs",
            contents: typescript::render_ts_utility_functions(&ts_napi_utilities),
        },
        GeneratedSourceFile {
            relative_path: "thetadatadx-cpp/include/fpss.hpp.inc",
