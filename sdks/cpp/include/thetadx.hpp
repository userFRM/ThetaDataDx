...
static_assert(offsetof(TdxFpssOhlcvc, contract) == 8,
              "TdxFpssOhlcvc::contract offset drifted");
static_assert(offsetof(TdxFpssOhlcvc, ms_of_day) == 40,
              "TdxFpssOhlcvc::ms_of_day offset drifted");
static_assert(offsetof(TdxFpssOhlcvc, open) == 48,
              "TdxFpssOhlcvc::open offset drifted");
static_assert(offsetof(TdxFpssOhlcvc, high) == 56,
              "TdxFpssOhlcvc::high offset drifted");
static_assert(offsetof(TdxFpssOhlcvc, low) == 64,
              "TdxFpssOhlcvc::low offset drifted");
static_assert(offsetof(TdxFpssOhlcvc, close) == 72,
              "TdxFpssOhlcvc::close offset drifted");
static_assert(offsetof(TdxFpssOhlcvc, volume) == 80,
              "TdxFpssOhlcvc::volume offset drifted");
static_assert(offsetof(TdxFpssOhlcvc, count) == 88,
              "TdxFpssOhlcvc::count offset drifted");
static_assert(offsetof(TdxFpssOhlcvc, date) == 96,
              "TdxFpssOhlcvc::date offset drifted");
static_assert(offsetof(TdxFpssOhlcvc, received_at_ns) == 104,
              "TdxFpssOhlcvc::received_at_ns offset drifted");
static_assert(sizeof(TdxFpssOhlcvc) == 112,
...
static_assert(offsetof(TdxFpssOpenInterest, contract) == 8,
              "TdxFpssOpenInterest::contract offset drifted");
static_assert(offsetof(TdxFpssOpenInterest, ms_of_day) == 40,
              "TdxFpssOpenInterest::ms_of_day offset drifted");
static_assert(offsetof(TdxFpssOpenInterest, open_interest) == 44,
              "TdxFpssOpenInterest::open_interest offset drifted");
static_assert(offsetof(TdxFpssOpenInterest, date) == 48,
              "TdxFpssOpenInterest::date offset drifted");
static_assert(offsetof(TdxFpssOpenInterest, received_at_ns) == 56,
              "TdxFpssOpenInterest::received_at_ns offset drifted");
static_assert(sizeof(TdxFpssOpenInterest) == 64,
...
static_assert(offsetof(TdxFpssQuote, contract) == 8,
              "TdxFpssQuote::contract offset drifted");
static_assert(offsetof(TdxFpssQuote, ms_of_day) == 40,
              "TdxFpssQuote::ms_of_day offset drifted");
static_assert(offsetof(TdxFpssQuote, bid_size) == 44,
              "TdxFpssQuote::bid_size offset drifted");
static_assert(offsetof(TdxFpssQuote, bid_exchange) == 48,
              "TdxFpssQuote::bid_exchange offset drifted");
static_assert(offsetof(TdxFpssQuote, bid) == 56,
              "TdxFpssQuote::bid offset drifted");
static_assert(offsetof(TdxFpssQuote, bid_condition) == 64,
              "TdxFpssQuote::bid_condition offset drifted");
static_assert(offsetof(TdxFpssQuote, ask_size) == 68,
              "TdxFpssQuote::ask_size offset drifted");
static_assert(offsetof(TdxFpssQuote, ask_exchange) == 72,
              "TdxFpssQuote::ask_exchange offset drifted");
static_assert(offsetof(TdxFpssQuote, ask) == 80,
              "TdxFpssQuote::ask offset drifted");
static_assert(offsetof(TdxFpssQuote, ask_condition) == 88,
              "TdxFpssQuote::ask_condition offset drifted");
static_assert(offsetof(TdxFpssQuote, date) == 92,
              "TdxFpssQuote::date offset drifted");
static_assert(offsetof(TdxFpssQuote, received_at_ns) == 96,
              "TdxFpssQuote::received_at_ns offset drifted");
static_assert(sizeof(TdxFpssQuote) == 104,
              "TdxFpssQuote total size drifted");

// TdxFpssTrade
static_assert(offsetof(TdxFpssTrade, contract_id) == 0,
              "TdxFpssTrade::contract_id offset drifted");
static_assert(offsetof(TdxFpssTrade, contract) == 8,
              "TdxFpssTrade::contract offset drifted");
static_assert(offsetof(TdxFpssTrade, ms_of_day) == 40,
              "TdxFpssTrade::ms_of_day offset drifted");
static_assert(offsetof(TdxFpssTrade, sequence) == 44,
              "TdxFpssTrade::sequence offset drifted");
static_assert(offsetof(TdxFpssTrade, ext_condition1) == 48,
              "TdxFpssTrade::ext_condition1 offset drifted");
static_assert(offsetof(TdxFpssTrade, ext_condition2) == 52,
              "TdxFpssTrade::ext_condition2 offset drifted");
static_assert(offsetof(TdxFpssTrade, ext_condition3) == 56,
              "TdxFpssTrade::ext_condition3 offset drifted");
static_assert(offsetof(TdxFpssTrade, ext_condition4) == 60,
              "TdxFpssTrade::ext_condition4 offset drifted");
static_assert(offsetof(TdxFpssTrade, condition) == 64,
              "TdxFpssTrade::condition offset drifted");
static_assert(offsetof(TdxFpssTrade, size) == 68,
              "TdxFpssTrade::size offset drifted");
static_assert(offsetof(TdxFpssTrade, exchange) == 72,
              "TdxFpssTrade::exchange offset drifted");
static_assert(offsetof(TdxFpssTrade, price) == 80,
              "TdxFpssTrade::price offset drifted");
static_assert(offsetof(TdxFpssTrade, condition_flags) == 88,
              "TdxFpssTrade::condition_flags offset drifted");
static_assert(offsetof(TdxFpssTrade, price_flags) == 92,
              "TdxFpssTrade::price_flags offset drifted");
static_assert(offsetof(TdxFpssTrade, volume_type) == 96,
              "TdxFpssTrade::volume_type offset drifted");
static_assert(offsetof(TdxFpssTrade, records_back) == 100,
              "TdxFpssTrade::records_back offset drifted");
static_assert(offsetof(TdxFpssTrade, date) == 104,
              "TdxFpssTrade::date offset drifted");
static_assert(offsetof(TdxFpssTrade, received_at_ns) == 112,
              "TdxFpssTrade::received_at_ns offset drifted");
static_assert(sizeof(TdxFpssTrade) == 120,
...
// check) still fails the build. Offsets recomputed with the embedded
// `TdxContract` inside each data variant (see the comment block above
// the data-variant asserts).
...
static_assert(offsetof(TdxFpssEvent, open_interest) == 120,
              "TdxFpssEvent::open_interest offset drifted");
static_assert(offsetof(TdxFpssEvent, quote) == 184,
              "TdxFpssEvent::quote offset drifted");
static_assert(offsetof(TdxFpssEvent, trade) == 288,
              "TdxFpssEvent::trade offset drifted");
static_assert(offsetof(TdxFpssEvent, control) == 408,
              "TdxFpssEvent::control offset drifted");
static_assert(offsetof(TdxFpssEvent, raw_data) == 424,
              "TdxFpssEvent::raw_data offset drifted");
static_assert(sizeof(TdxFpssEvent) == 448,
