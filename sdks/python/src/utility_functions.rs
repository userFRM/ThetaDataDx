...
fn all_greeks(
    ...
    let g = tdbe::greeks::all_greeks(spot, strike, rate, div_yield, tte, option_price, right).map_err(thetadatadx::Error::from).map_err(to_py_err)?;
    Ok(AllGreeks {
        value: g.value,
        iv: g.iv,
        iv_error: g.iv_error,
...
fn implied_volatility(
    ...
    tdbe::greeks::implied_volatility(spot, strike, rate, div_yield, tte, option_price, right).map_err(thetadatadx::Error::from).map_err(to_py_err)
}
