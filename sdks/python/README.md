...
Drop-in Python SDK for ThetaData market data. Full terminal
...
local proxy. Every call crosses the PyO3 boundary into compiled Rust:
gRPC, protobuf parsing, zstd decompression, FIT tick decoding, and
TCP streaming all run natively.
