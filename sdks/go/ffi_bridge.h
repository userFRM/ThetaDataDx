...
extern void tdx_greeks_all_tick_array_free(TdxTickArray arr);
extern void tdx_greeks_first_order_tick_array_free(TdxTickArray arr);
extern void tdx_greeks_second_order_tick_array_free(TdxTickArray arr);
extern void tdx_greeks_third_order_tick_array_free(TdxTickArray arr);
