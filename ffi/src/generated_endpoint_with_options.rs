...
/// Stream all trades for a stock on a given date, chunk-by-chunk. with optional builder parameters.
#[no_mangle]
pub unsafe extern "C" fn tdx_stock_history_trade_stream_with_options(
    client: *const TdxClient,
    symbol: *const c_char
,
    date: *const c_char
,
    ...
    let client = unsafe { &*client };
    match runtime().block_on(async {
        thetadatadx::endpoint::invoke_endpoint(&client.inner, "stock_history_trade_stream", &args).await
    }) {
        Ok(thetadatadx::EndpointOutput::TradeTicks(values)) => TdxTradeTickArray::from_vec(values),
        Ok(other) => {
            set_error(&format!("internal error: unexpected endpoint output for stock_history_trade_stream: {other:?}"));
            empty
        }
        Err(error) => {
            set_error(&error.to_string());
...
/// Stream NBBO quotes for a stock on a given date, chunk-by-chunk. with optional builder parameters.
#[no_mangle]
pub unsafe extern "C" fn tdx_stock_history_quote_stream_with_options(
    client: *const TdxClient,
    symbol: *const c_char
,
    date: *const c_char
...
,
    ...
    let client = unsafe { &*client };
    match runtime().block_on(async {
        thetadatadx::endpoint::invoke_endpoint(&client.inner, "stock_history_quote_stream", &args).await
    }) {
        Ok(thetadatadx::EndpointOutput::QuoteTicks(values)) => TdxQuoteTickArray::from_vec(values),
        Ok(other) => {
            set_error(&format!("internal error: unexpected endpoint output for stock_history_quote_stream: {other:?}"));
            empty
        }
        Err(error) => {
            set_error(&error.to_string());
...
/// Stream all trades for an option contract, chunk-by-chunk. with optional builder parameters.
#[no_mangle]
pub unsafe extern "C" fn tdx_option_history_trade_stream_with_options(
    client: *const TdxClient,
    symbol: *const c_char
,
    expiration: *const c_char
...
,
    ...
    let client = unsafe { &*client };
    match runtime().block_on(async {
        thetadatadx::endpoint::invoke_endpoint(&client.inner, "option_history_trade_stream", &args).await
    }) {
        Ok(thetadatadx::EndpointOutput::TradeTicks(values)) => TdxTradeTickArray::from_vec(values),
        Ok(other) => {
            set_error(&format!("internal error: unexpected endpoint output for option_history_trade_stream: {other:?}"));
            empty
        }
        Err(error) => {
            set_error(&error.to_string());
...
/// Stream NBBO quotes for an option contract, chunk-by-chunk. with optional builder parameters.
#[no_mangle]
pub unsafe extern "C" fn tdx_option_history_quote_stream_with_options(
    client: *const TdxClient,
    symbol: *const c_char
,
    expiration: *const c_char
...
,
    ...
    let client = unsafe { &*client };
    match runtime().block_on(async {
        thetadatadx::endpoint::invoke_endpoint(&client.inner, "option_history_quote_stream", &args).await
    }) {
        Ok(thetadatadx::EndpointOutput::QuoteTicks(values)) => TdxQuoteTickArray::from_vec(values),
        Ok(other) => {
            set_error(&format!("internal error: unexpected endpoint output for option_history_quote_stream: {other:?}"));
            empty
        }
        Err(error) => {
            set_error(&error.to_string());
