...
// The uniform static config accessors (scalar + duration setters/getters)
// are generated from `config_surface.toml`; the divergent accessors above
// (string, enum, Option-widened, policy-aware, validated) stay hand-written.
