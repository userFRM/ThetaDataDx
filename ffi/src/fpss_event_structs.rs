...
// `TdxStreamEvent`. `include!`'d from `ffi/src/lib.rs`; do not hand-edit.
// Expects `std::os::raw::c_char`, `std::ptr` already in scope at the
// include site.

/// FPSS event kind tag. Check this to determine which field of
/// `TdxStreamEvent` is valid. One discriminant per data variant
...
#[repr(C)]
pub struct TdxStreamMarketValue {
...
#[repr(C)]
pub struct TdxStreamOpenInterest {
    /// Contract this event refers to.
    pub contract: TdxContract,
    /// Milliseconds since midnight (exchange-local) when the event was recorded.
    pub ms_of_day: i32,
...
#[repr(C)]
pub struct TdxStreamContractAssigned {
...
#[repr(C)]
pub struct TdxStreamDisconnected {
...
#[repr(C)]
pub struct TdxStreamLoginSuccess {
...
#[repr(C)]
pub struct TdxStreamMarketClose {
    /// Placeholder so the struct has size 1 on every C compiler.
    /// Empty `#[repr(C)]` structs are size 0 on Rust but size 1 on
    /// MSVC; the byte keeps the layout consistent across both.
    pub _padding: u8,
...
#[repr(C)]
pub struct TdxStreamMarketOpen {
    /// Placeholder so the struct has size 1 on every C compiler.
    /// Empty `#[repr(C)]` structs are size 0 on Rust but size 1 on
    /// MSVC; the byte keeps the layout consistent across both.
    pub _padding: u8,
...
#[repr(C)]
pub struct TdxStreamParseError {
...
#[repr(C)]
pub struct TdxStreamReconnected {
    /// Placeholder so the struct has size 1 on every C compiler.
    /// Empty `#[repr(C)]` structs are size 0 on Rust but size 1 on
    /// MSVC; the byte keeps the layout consistent across both.
    pub _padding: u8,
...
#[repr(C)]
pub struct TdxStreamReconnectedServer {
    /// Placeholder so the struct has size 1 on every C compiler.
    /// Empty `#[repr(C)]` structs are size 0 on Rust but size 1 on
    /// MSVC; the byte keeps the layout consistent across both.
    pub _padding: u8,
...
#[repr(C)]
pub struct TdxStreamReconnecting {
    /// Reason the server gave for dropping the connection.
    pub reason: i32,
...
#[repr(C)]
pub struct TdxStreamReconnectsExhausted {
    /// Reason the server gave for dropping the connection.
    pub reason: i32,
...
#[repr(C)]
pub struct TdxStreamReqResponse {
...
#[repr(C)]
pub struct TdxStreamServerError {
    /// Human-readable error text from the server.
    pub message: *const c_char,
}
...
#[repr(C)]
pub struct TdxStreamUnknownControl {
    /// Placeholder so the struct has size 1 on every C compiler.
    /// Empty `#[repr(C)]` structs are size 0 on Rust but size 1 on
    /// MSVC; the byte keeps the layout consistent across both.
    pub _padding: u8,
...
#[repr(C)]
pub struct TdxStreamUnknownFrame {
...
pub(crate) const ZERO_OHLCVC: TdxStreamOhlcvc = TdxStreamOhlcvc {
    contract: ZERO_CONTRACT_STRUCT,
    ms_of_day: 0,
    open: 0.0,
    high: 0.0,
...
pub(crate) const ZERO_OI: TdxStreamOpenInterest = TdxStreamOpenInterest {
    contract: ZERO_CONTRACT_STRUCT,
    ms_of_day: 0,
    open_interest: 0,
    date: 0,
...
pub(crate) const ZERO_QUOTE: TdxStreamQuote = TdxStreamQuote {
    contract: ZERO_CONTRACT_STRUCT,
    ms_of_day: 0,
    bid_size: 0,
    bid_exchange: 0,
...
pub(crate) const ZERO_TRADE: TdxStreamTrade = TdxStreamTrade {
    contract: ZERO_CONTRACT_STRUCT,
    ms_of_day: 0,
    sequence: 0,
    ext_condition1: 0,
...
pub(crate) const ZERO_CONNECTED: TdxStreamConnected = TdxStreamConnected {
    _padding: 0,
};
pub(crate) const ZERO_CONTRACT_ASSIGNED: TdxStreamContractAssigned = TdxStreamContractAssigned {
    id: 0,
    contract: ZERO_CONTRACT_STRUCT,
};
pub(crate) const ZERO_DISCONNECTED: TdxStreamDisconnected = TdxStreamDisconnected {
    reason: 0,
};
pub(crate) const ZERO_LOGIN_SUCCESS: TdxStreamLoginSuccess = TdxStreamLoginSuccess {
    permissions: ptr::null(),
};
pub(crate) const ZERO_MARKET_CLOSE: TdxStreamMarketClose = TdxStreamMarketClose {
    _padding: 0,
};
pub(crate) const ZERO_MARKET_OPEN: TdxStreamMarketOpen = TdxStreamMarketOpen {
    _padding: 0,
};
pub(crate) const ZERO_PARSE_ERROR: TdxStreamParseError = TdxStreamParseError {
    message: ptr::null(),
};
pub(crate) const ZERO_PING: TdxStreamPing = TdxStreamPing {
    payload: ptr::null(),
    payload_len: 0,
};
pub(crate) const ZERO_RECONNECTED: TdxStreamReconnected = TdxStreamReconnected {
    _padding: 0,
};
pub(crate) const ZERO_RECONNECTED_SERVER: TdxStreamReconnectedServer = TdxStreamReconnectedServer {
    _padding: 0,
};
pub(crate) const ZERO_RECONNECTING: TdxStreamReconnecting = TdxStreamReconnecting {
    reason: 0,
    attempt: 0,
    delay_ms: 0,
};
pub(crate) const ZERO_RECONNECTS_EXHAUSTED: TdxStreamReconnectsExhausted = TdxStreamReconnectsExhausted {
    reason: 0,
    attempts: 0,
};
pub(crate) const ZERO_REQ_RESPONSE: TdxStreamReqResponse = TdxStreamReqResponse {
    req_id: 0,
    result: 0,
};
pub(crate) const ZERO_RESTART: TdxStreamRestart = TdxStreamRestart {
    _padding: 0,
};
pub(crate) const ZERO_SERVER_ERROR: TdxStreamServerError = TdxStreamServerError {
    message: ptr::null(),
};
pub(crate) const ZERO_UNKNOWN_CONTROL: TdxStreamUnknownControl = TdxStreamUnknownControl {
    _padding: 0,
};
pub(crate) const ZERO_UNKNOWN_FRAME: TdxStreamUnknownFrame = TdxStreamUnknownFrame {
    code: 0,
    payload: ptr::null(),
    payload_len: 0,
};
