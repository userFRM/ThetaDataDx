...
pub(crate) struct EodTick {
    ...
    #[pyo3(get)] pub bid_exchange: Option<i32>,
    #[pyo3(get)] pub bid: f64,
    #[pyo3(get)] pub bid_condition: Option<i32>,
    #[pyo3(get)] pub ask_size: i32,
    #[pyo3(get)] pub ask_exchange: Option<i32>,
    #[pyo3(get)] pub ask: f64,
    #[pyo3(get)] pub ask_condition: Option<i32>,
    #[pyo3(get)] pub date: i32,
...
impl EodTick {
    #[new]
    #[pyo3(signature = (*, created_ms_of_day = 0i32, last_trade_ms_of_day = 0i32, open = 0.0f64, high = 0.0f64, low = 0.0f64, close = 0.0f64, volume = 0i64, count = 0i64, bid_size = 0i32, bid_exchange = None, bid = 0.0f64, bid_condition = None, ask_size = 0i32, ask_exchange = None, ask = 0.0f64, ask_condition = None, date = 0i32, expiration = None, strike = None, right = None))]
    fn new(created_ms_of_day: i32, last_trade_ms_of_day: i32, open: f64, high: f64, low: f64, close: f64, volume: i64, count: i64, bid_size: i32, bid_exchange: Option<i32>, bid: f64, bid_condition: Option<i32>, ask_size: i32, ask_exchange: Option<i32>, ask: f64, ask_condition: Option<i32>, date: i32, expiration: Option<i32>, strike: Option<f64>, right: Option<String>) -> Self {
        Self {
            created_ms_of_day,
...
pub(crate) struct IndexPriceAtTimeTick {
    ...
    #[pyo3(get)] pub ext_condition1: Option<i32>,
    #[pyo3(get)] pub ext_condition2: Option<i32>,
    #[pyo3(get)] pub ext_condition3: Option<i32>,
    #[pyo3(get)] pub ext_condition4: Option<i32>,
    #[pyo3(get)] pub condition: Option<i32>,
    #[pyo3(get)] pub size: i32,
    #[pyo3(get)] pub exchange: Option<i32>,
...
impl IndexPriceAtTimeTick {
    #[new]
    #[pyo3(signature = (*, ms_of_day = 0i32, sequence = 0i32, ext_condition1 = None, ext_condition2 = None, ext_condition3 = None, ext_condition4 = None, condition = None, size = 0i32, exchange = None, price = 0.0f64, date = 0i32))]
    fn new(ms_of_day: i32, sequence: i32, ext_condition1: Option<i32>, ext_condition2: Option<i32>, ext_condition3: Option<i32>, ext_condition4: Option<i32>, condition: Option<i32>, size: i32, exchange: Option<i32>, price: f64, date: i32) -> Self {
        Self {
            ms_of_day,
            sequence,
            ext_condition1,
    ...
    fn __repr__(&self) -> String {
        format!("IndexPriceAtTimeTick(ms_of_day={}, sequence={}, ext_condition1={}, ext_condition2={}, ext_condition3={}, ext_condition4={})", self.ms_of_day, self.sequence, self.ext_condition1.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition2.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition3.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition4.map_or_else(|| "None".to_string(), |v| v.to_string()))
    }
...
impl QuoteTick {
    #[new]
    #[pyo3(signature = (*, ms_of_day = 0i32, bid_size = 0i32, bid_exchange = None, bid = 0.0f64, bid_condition = None, ask_size = 0i32, ask_exchange = None, ask = 0.0f64, ask_condition = None, date = 0i32, expiration = None, strike = None, right = None))]
    fn new(ms_of_day: i32, bid_size: i32, bid_exchange: Option<i32>, bid: f64, bid_condition: Option<i32>, ask_size: i32, ask_exchange: Option<i32>, ask: f64, ask_condition: Option<i32>, date: i32, expiration: Option<i32>, strike: Option<f64>, right: Option<String>) -> Self {
        Self {
            ms_of_day,
            bid_size,
            bid_exchange,
    ...
    fn __repr__(&self) -> String {
        format!("QuoteTick(ms_of_day={}, bid_size={}, bid_exchange={}, bid={}, bid_condition={}, ask_size={})", self.ms_of_day, self.bid_size, self.bid_exchange.map_or_else(|| "None".to_string(), |v| v.to_string()), self.bid, self.bid_condition.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ask_size)
    }
...
impl TradeGreeksAllTick {
    ...
    fn __repr__(&self) -> String {
        format!("TradeGreeksAllTick(ms_of_day={}, sequence={}, ext_condition1={}, ext_condition2={}, ext_condition3={}, ext_condition4={})", self.ms_of_day, self.sequence, self.ext_condition1.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition2.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition3.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition4.map_or_else(|| "None".to_string(), |v| v.to_string()))
    }
...
impl TradeGreeksFirstOrderTick {
    ...
    fn __repr__(&self) -> String {
        format!("TradeGreeksFirstOrderTick(ms_of_day={}, sequence={}, ext_condition1={}, ext_condition2={}, ext_condition3={}, ext_condition4={})", self.ms_of_day, self.sequence, self.ext_condition1.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition2.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition3.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition4.map_or_else(|| "None".to_string(), |v| v.to_string()))
    }
...
impl TradeGreeksImpliedVolatilityTick {
    ...
    fn __repr__(&self) -> String {
        format!("TradeGreeksImpliedVolatilityTick(ms_of_day={}, sequence={}, ext_condition1={}, ext_condition2={}, ext_condition3={}, ext_condition4={})", self.ms_of_day, self.sequence, self.ext_condition1.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition2.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition3.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition4.map_or_else(|| "None".to_string(), |v| v.to_string()))
    }
...
impl TradeGreeksSecondOrderTick {
    ...
    fn __repr__(&self) -> String {
        format!("TradeGreeksSecondOrderTick(ms_of_day={}, sequence={}, ext_condition1={}, ext_condition2={}, ext_condition3={}, ext_condition4={})", self.ms_of_day, self.sequence, self.ext_condition1.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition2.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition3.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition4.map_or_else(|| "None".to_string(), |v| v.to_string()))
    }
...
impl TradeGreeksThirdOrderTick {
    ...
    fn __repr__(&self) -> String {
        format!("TradeGreeksThirdOrderTick(ms_of_day={}, sequence={}, ext_condition1={}, ext_condition2={}, ext_condition3={}, ext_condition4={})", self.ms_of_day, self.sequence, self.ext_condition1.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition2.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition3.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition4.map_or_else(|| "None".to_string(), |v| v.to_string()))
    }
...
impl TradeQuoteTick {
    #[new]
    #[pyo3(signature = (*, ms_of_day = 0i32, sequence = 0i32, ext_condition1 = None, ext_condition2 = None, ext_condition3 = None, ext_condition4 = None, condition = None, size = 0i32, exchange = None, price = 0.0f64, condition_flags = 0i32, price_flags = 0i32, volume_type = 0i32, records_back = 0i32, quote_ms_of_day = 0i32, bid_size = 0i32, bid_exchange = None, bid = 0.0f64, bid_condition = None, ask_size = 0i32, ask_exchange = None, ask = 0.0f64, ask_condition = None, date = 0i32, expiration = None, strike = None, right = None))]
    fn new(ms_of_day: i32, sequence: i32, ext_condition1: Option<i32>, ext_condition2: Option<i32>, ext_condition3: Option<i32>, ext_condition4: Option<i32>, condition: Option<i32>, size: i32, exchange: Option<i32>, price: f64, condition_flags: i32, price_flags: i32, volume_type: i32, records_back: i32, quote_ms_of_day: i32, bid_size: i32, bid_exchange: Option<i32>, bid: f64, bid_condition: Option<i32>, ask_size: i32, ask_exchange: Option<i32>, ask: f64, ask_condition: Option<i32>, date: i32, expiration: Option<i32>, strike: Option<f64>, right: Option<String>) -> Self {
        Self {
            ms_of_day,
            sequence,
            ext_condition1,
    ...
    fn __repr__(&self) -> String {
        format!("TradeQuoteTick(ms_of_day={}, sequence={}, ext_condition1={}, ext_condition2={}, ext_condition3={}, ext_condition4={})", self.ms_of_day, self.sequence, self.ext_condition1.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition2.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition3.map_or_else(|| "None".to_string(), |v| v.to_string()), self.ext_condition4.map_or_else(|| "None".to_string(), |v| v.to_string()))
    }
...
impl TradeTick {
    #[new]
    #[pyo3(signature = (*, ms_of_day = 0i32, sequence = 0i32, ext_condition1 = None, ext_condition2 = None, ext_condition3 = None, ext_condition4 = None, condition = None, size = 0i32, exchange = None, price = 0.0f64, condition_flags = 0i32, price_flags = 0i32, volume_type = 0i32, records_back = 0i32, date = 0i32, expiration = None, strike = None, right = None))]
    fn new(ms_of_day: i32, sequence: i32, ext_condition1: Option<i32>, ext_condition2: Option<i32>, ext_condition3: Option<i32>, ext_condition4: Option<i32>, condition: Option<i32>, size: i32, exchange: Option<i32>, price: f64, condition_flags: i32, price_flags: i32, volume_type: i32, records_back: i32, date: i32, expiration: Option<i32>, strike: Option<f64>, right: Option<String>) -> Self {
        Self {
            ms_of_day,
            sequence,
            ext_condition1,
    ...
    fn is_cancelled(&self) -> bool {
        self.condition.is_some_and(|cell| (40..=44).contains(&cell))
    }
}
    ...
    fn py_new(ticks: Vec<pyo3::PyRef<'_, EodTick>>) -> PyResult<Self> {
        ...
        for t in &ticks {
            inner.push(            tick::EodTick {
                ...
                count: t.count,
                bid_size: t.bid_size,
                bid_exchange: t.bid_exchange.unwrap_or(0),
                has_bid_exchange: t.bid_exchange.is_some(),
                bid: t.bid,
                bid_condition: t.bid_condition.unwrap_or(0),
                has_bid_condition: t.bid_condition.is_some(),
                ask_size: t.ask_size,
                ask_exchange: t.ask_exchange.unwrap_or(0),
                has_ask_exchange: t.ask_exchange.is_some(),
                ask: t.ask,
                ask_condition: t.ask_condition.unwrap_or(0),
                has_ask_condition: t.ask_condition.is_some(),
                date: t.date,
    ...
    fn py_new(ticks: Vec<pyo3::PyRef<'_, IndexPriceAtTimeTick>>) -> PyResult<Self> {
        ...
        for t in &ticks {
            inner.push(            tick::IndexPriceAtTimeTick {
                ms_of_day: t.ms_of_day,
                sequence: t.sequence,
                ext_condition1: t.ext_condition1.unwrap_or(0),
                has_ext_condition1: t.ext_condition1.is_some(),
                ext_condition2: t.ext_condition2.unwrap_or(0),
                has_ext_condition2: t.ext_condition2.is_some(),
                ext_condition3: t.ext_condition3.unwrap_or(0),
                has_ext_condition3: t.ext_condition3.is_some(),
                ext_condition4: t.ext_condition4.unwrap_or(0),
                has_ext_condition4: t.ext_condition4.is_some(),
                condition: t.condition.unwrap_or(0),
                has_condition: t.condition.is_some(),
                size: t.size,
                exchange: t.exchange.unwrap_or(0),
                has_exchange: t.exchange.is_some(),
                price: t.price,
                date: t.date,
            }
            );
