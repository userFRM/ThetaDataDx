...
thetadatadx = pytest.importorskip(
    "thetadatadx",
    reason="native thetadatadx extension not built -- run `maturin develop` from thetadatadx-py/",
)
...
def test_trade_tick_flag_accessors_decode_condition_words():
    ...
    assert fired.us_regular_trading_hours is True
    ...
    assert quiet.us_regular_trading_hours is False
