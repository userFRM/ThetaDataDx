...
`thetadatadx-rs/src/tdbe/conditions/mod.rs` and
`thetadatadx-rs/src/tdbe/exchange.rs`, so cross-language drift trips this test.
"""
...
def test_condition_name_known_codes(util):
    # Mirrors thetadatadx-rs/src/tdbe/conditions/mod.rs: condition_name(0) == "REGULAR",
...
def test_exchange_name_known_codes(util):
    # Mirrors thetadatadx-rs/src/tdbe/exchange.rs: exchange_name(0) == "Composite",
