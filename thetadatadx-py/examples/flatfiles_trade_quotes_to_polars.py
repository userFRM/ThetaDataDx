...
Run with a credentials file: ``python flatfiles_trade_quotes_to_polars.py``.
"""
...
# Whole-universe option trade-quotes for one trading day. Several hundred MB
...
print(f"option_trade_quote rows: {len(rows)}")
...
path = client.flatfile_to_path(
    "OPTION", "TRADE_QUOTE", "20260428", "/tmp/option-trade-quote", format="csv"
)
