...
- Improve ease of use for common historical, realtime, and analytics workflows.
...
### 5. Historical and Realtime Should Feel Coherent
...
- `client.realtime().subscribe_quotes(...)`
...
- cross-language basic workflow tests for historical, realtime, and analytics
