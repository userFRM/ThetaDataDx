...
|------|------|-------------|
| MCP server | [`tools/mcp/`](mcp/README.md) | Model Context Protocol server (`thetadatadx-mcp-server`). Exposes every generated market-data endpoint plus one offline tool (`ping`) as JSON-RPC 2.0 tool calls over stdio. |
