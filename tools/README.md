...
|------|------|-------------|
| MCP server | [`tools/mcp/`](mcp/README.md) | Model Context Protocol server (`thetadatadx-mcp`). Exposes every generated historical endpoint plus one offline tool (`ping`) as JSON-RPC 2.0 tool calls over stdio. |
